    ...
    <v-card-title>
      <div style="width: 100%; display: flex; align-items: center; justify-content: space-between">
        <span>
          ...
          <v-btn @click="$emit('move-up-group')" :disabled="loading" class="ml-2" icon="mdi-arrow-up"
                 variant="text" size="small" />
          <v-btn @click="$emit('move-down-group')" :disabled="loading" icon="mdi-arrow-down"
                 variant="text" size="small" />
          <v-btn @click="$emit('update-group')" :disabled="loading" icon="mdi-pencil"
                 variant="text" size="small" />
          <v-btn @click="$emit('delete-group')" :disabled="loading" icon="mdi-delete"
                 variant="text" size="small" />
        </span>
        <span>
          <v-btn @click="$emit('create-file')" :disabled="loading" color="primary" size="small">
    ...
    <v-card-text>
      ...
      <v-row no-gutters>
        ...
        <v-col cols="4" class="pa-4">
          ...
          <img v-if="audioImage" :src="audioImage" style="width: 100%" alt="Audio Image"/>
        </v-col>
      </v-row>
